...
def create_mcp_node(**kwargs):
    """
    Factory function for MCPNode. 
    Expects 'mcp_client' in kwargs, or initializes a default one.
    """
    # Example: If mcp_client isn't passed in args, you could initialize a global one here
